...
- Integration instructions written for publishers (how to add the adapter, configure MAX, handle privacy).
...
2. No internal repo names, field names, or roadmap content in any committed file.
